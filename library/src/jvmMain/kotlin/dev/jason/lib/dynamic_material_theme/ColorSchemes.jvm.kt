...
actual fun getLightScheme(seedColor: Long): ColorScheme = createColorScheme(seedColor, false)

actual fun getDarkScheme(seedColor: Long): ColorScheme = createColorScheme(seedColor, true)

private fun createColorScheme(seedColor: Long, isDark: Boolean): ColorScheme {
    val argb = ((seedColor and 0xFFFFFF) or 0xFF000000).toInt()
